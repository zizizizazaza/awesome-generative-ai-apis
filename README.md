...
| [Hetu Protocol](https://parallel.hetu.org/) | [Link](https://parallel.hetu.org/apikey/pricing) | Y | P2P-based inference network with OpenAI SDK compatibility. Free tier with open-source models (Llama-3, Qwen-2, Mixtral, DeepSeek). Trial credits: 5M tokens for full model access (GPT-4o, Claude 3.5). |
